...
export const getFlightsListForRouteInventory = ( route_id ) => ({
  type: "GET_FLIGHTS_LIST_INVENTORY",
  payload: axios({
    // withCredentials:true,
    url: `http://siachallenge.reversethatshell.com/php/siachallenge/getflightsforpassengerroute.php?routeID=${route_id}`
  })
})

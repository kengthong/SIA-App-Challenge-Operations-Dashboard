...
const inventoryFacilitiesList = {
  loading:false,
  data: false,
  history: false,

}
 export const inventoryFacilitiesReducer = (state = inventoryFacilitiesList, action ) => {
   switch (action.type) {
     case "GET_FACILITIES_DETAILS_PENDING":
        return {
          ...state,
          loading:true
        }

    case "GET_FACILITIES_DETAILS_FULFILLED":
        return {
          ...state,
          loading: false,
          data: action.facilitiesData
        }
     case "UPDATE_INPUT_CHANGE":


     case "GET_FACILITIES_HISTORY_PENDING":
      return {
        ...state,
        loading: true,
      }
     ...
     case "GET_FACILITIES_HISTORY_FULFILLED":
      return {
        ...state,
        loading: false,

...
const flightRoutesList = [
 ...
 export const flightRoutesReducer = (state = flightRoutesList, action ) => {
   switch (action.type) {
     case "GET_ROUTE_DETAILS_PENDING":
        return {
          ...state,
          loading:true
        }
    ...
    //     if (this.state.flightRoutesList != action.flightRoutesList) {
    //       return{
    //         ...state,
    //         flightRoutesList: action.flightRoutesList
    //       }
    //     }

     case "GET_ROUTE_DETAILS_FULFILLED":
        return{
          ...state,
          loading: false,
